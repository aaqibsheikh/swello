  ...
  return (
    <div className="flex lg:flex-row flex-col">
      <div className="lg:pt-24 md:pt-10 pt-4 flex flex-col lg:pl-20 lg:px-0 md:px-32 px-4">
        ...
        <p className="lg:order-3 order-4 uppercase  font-blender font-bold text-xl text-white mb-2.5 lg:hidden block mt-10">Next Reward</p>
        ...
        <p className="lg:order-3 order-4 uppercase  font-blender font-bold text-xl text-white mb-2.5 lg:hidden block mt-7">Lifetime Gains</p>
      ...
      <div className="flex-1">
        ...
        <div className="px-4">
          <div className="mt-10 bg-[#0F0F13] pt-12 lg:pl-16 pl-4 lg:pr-12 pr-4" style={{borderRadius: '20px 20px 0px 0px'}}>
            <hr className=" w-28 mx-auto rounded-full h-1 mb-6 lg:hidden block" style={{boder: '4px solid #5B5B65'}} />
            ...
            <div className="reward-history mt-12 pb-24">
              ...
              <hr style={{border: '1px solid #2C2C35'}} className="my-5 lg:hidden block" />
